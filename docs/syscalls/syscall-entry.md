...
- [32-bit Compat Syscalls](compat.md) — the ia32 compat layer, the sibling mechanism to `do_syscall_x32()`'s x32 ABI handling for 32-bit userspace on a 64-bit kernel
