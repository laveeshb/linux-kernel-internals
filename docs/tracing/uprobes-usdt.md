...
/* uprobe structure: */
struct uprobe {
    struct rb_node   rb_node;    /* in uprobe_tree per-mm */
    refcount_t       ref;
    rwsem            register_rwsem;
...
/* arch/x86/mm/fault.c: do_trap → uprobe_pre_sstep_notifier */
int uprobe_notify_resume(struct pt_regs *regs)
{
