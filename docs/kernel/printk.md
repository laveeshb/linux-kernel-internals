...
/*
 * Ring buffer is a lock-free single-producer multi-consumer design.
...
asmlinkage int vprintk_emit(int facility, int level,
                             const struct dev_printk_id *dev_info,
...
```c
/* Avoid log flooding: */
printk_ratelimited(KERN_WARN "my_driver: spurious interrupt\n");
