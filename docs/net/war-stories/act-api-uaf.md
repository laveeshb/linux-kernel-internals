...
Two people found the same bug in Linux's traffic-control code within days of each other, for completely unrelated reasons — and each was unaware of the other. A security researcher at OpenAI quietly reported a use-after-free upstream through normal channels. Separately, an intern at a Singapore security firm — hunting kernel bugs with AI assistance ahead of a hacking competition — found the identical bug on his own, built it into a full local-root exploit, and only learned afterward that he'd been beaten to the disclosure by two days. The vulnerability, CVE-2026-53264, wasn't the result of sloppy code: it's what happens when two separate, individually reasonable kernel changes, made years apart, quietly combine into something neither author could have anticipated — leaving a window where deleting a network filter could free memory another CPU was still about to use.
...
Lee's own summary of AI's contribution is more modest than "found and built it for me": *"It was certainly helpful for iterating quickly, but still lacking in reasoning ability and having clear blind spots. It was still crucial to exercise my own judgement especially when fine-tuning."* His stated takeaway from the exercise was narrower than "AI finds 0-days" — that AI tooling made *hunting an unknown bug* start to feel, procedurally, like the easier problem of analyzing an already-known one: *"In a sense, this made it feel more like I was doing n-day analysis even on new bugs."*
