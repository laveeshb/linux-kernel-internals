...
- [Databricks: Adventures in the TCP stack](https://www.databricks.com/blog/2019/09/16/adventures-in-the-tcp-stack-performance-regressions-vulnerability-fixes.html) — an independent account of the CVE-2019-11478 fix causing a 6x S3-write slowdown via `sendfile()`/zerocopy overshoot of `SO_SNDBUF`
