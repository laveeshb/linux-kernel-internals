...
- [fw_devlink=on: The Default That Broke Boot Twice Before It Stuck](fw-devlink-boot-breaking.md) — the mechanism this page describes, made automatic and turned on by default nearly a decade later, with a rollout that broke boot twice (and was reverted once) before it stuck
...
- [LWN: Grant Likely's v2 patch, "drivercore: Add driver probe deferral mechanism"](https://lwn.net/Articles/450178/) — July 4, 2011, three days before Corbet's article, no OLPC reference
