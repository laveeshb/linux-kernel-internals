...
- [fw_devlink=on: The Default That Broke Boot Twice Before It Stuck](fw-devlink-boot-breaking.md) — the mechanism this page describes, made automatic and turned on by default nearly a decade later, with its own twice-reverted rollout before it stuck
