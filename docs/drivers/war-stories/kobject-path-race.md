...
- [The uevent_show() Fix That Deadlocked Driver Detach](uevent-show-deadlock.md) — a different driver-core race, in the same uevent-generation code path, fixed by adding synchronization rather than removing it
