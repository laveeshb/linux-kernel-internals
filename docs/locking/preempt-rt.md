...
- [kernel/printk/nbcon.c](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/kernel/printk/nbcon.c) — `nbcon_can_proceed()` and the `NBCON_PRIO_*` takeover levels behind the printk fix
