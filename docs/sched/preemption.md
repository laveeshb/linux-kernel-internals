...
PREEMPT_RT (fully merged in 6.12 for all architectures) converts almost all spinlocks to sleeping mutexes, allowing preemption even while holding a "spinlock":
