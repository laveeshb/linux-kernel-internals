...
**Cgroup v2** (default on modern kernels, via `mem_cgroup_print_oom_meminfo()` in [`mm/memcontrol.c`](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/mm/memcontrol.c)):
