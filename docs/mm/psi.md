...
int main(void) {
    ...
    /* Trigger when "some" memory pressure exceeds 10%
       over a 1-second window (1000000 us) */
...
- The window must be a multiple of 500ms, up to 10 seconds.
...
- **systemd**: systemd-oomd [introduced in systemd v247](https://lwn.net/Articles/834768/) (2020)
...
- [Monitoring memory pressure with PSI](https://lwn.net/Articles/834768/) — systemd-oomd and PSI triggers
