...
- **Source**: [`si_meminfo()`](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/mm/page_alloc.c) returns `totalram_pages()`, set during boot.
...
Memory used by the kernel slab allocator's caches (SLUB by default since [v2.6.23](https://git.kernel.org/linus/a0acd820)).
...
- [`mm/page_alloc.c`](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/mm/page_alloc.c) — `si_meminfo()`
- [`mm/show_mem.c`](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/mm/show_mem.c) — `si_mem_available()`
