...
Reported by
:   Intel's own internal research team, extending the academic Foreshadow/SGX research (CVE-2018-3615) that preceded it
...
- [git.kernel.org: 958f338e96f87](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=958f338e96f874a0d29442396d6adf9c1e17aa2d) — the merged "l1tf-final" series that landed the KVM mitigations in mainline
...
- [CERT/CC VU#982149](https://www.kb.cert.org/vuls/id/982149) — coordinated disclosure summary covering the full three-CVE Foreshadow-NG family; its acknowledgments section credits "L1TF OS/SMM and L1TF VMM were found internally by Intel researchers after expanding on the research of L1TF SGX"
- [Foreshadow attack research](https://foreshadowattack.eu/) — the original SGX-focused Foreshadow research (CVE-2018-3615), independently and concurrently discovered by two teams (KU Leuven/imec-DistriNet, and separately Technion, University of Michigan, and University of Adelaide/CSIRO's Data61), whose findings Intel extended internally to identify the OS/SMM and VMM variants covered by this page
