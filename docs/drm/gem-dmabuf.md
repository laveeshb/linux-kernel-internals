...
- [lore.kernel.org: [RFC v2] Introduce DMA buffer sharing mechanism](https://lore.kernel.org/dri-devel/1322816252-19955-1-git-send-email-sumit.semwal@ti.com/) — the December 2011 RFC round where the subsystem-agnostic design was argued over
...
- [lore.kernel.org: expected userspace prime/dma-buf usage](https://lore.kernel.org/dri-devel/CAPM=9tyBcJWWp0nwnGhJsG60YNmo9eKYaD+c8nOtKjnuDeUwRg@mail.gmail.com/) — Dave Airlie's case for a file descriptor over another global buffer-name hash
