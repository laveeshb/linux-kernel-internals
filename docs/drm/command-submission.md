...
- [lore.kernel.org: Add GPU scheduler to amdgpu](https://lore.kernel.org/dri-devel/1438381367-24980-2-git-send-email-alexander.deucher@amd.com/) — the 31-patch series that introduced it, posted as a finished batch with zero replies
